...
module.exports = function(sequelize)
{
	...
	const profiles = app.service('profiles').Model; //Nelor Don't forget to make sure the service already exists when you establishthis one.
	...
	.then(function()
	{
		console.log("Table 'user' synchronised.");
	},
	function(err)
	{
		console.log(err);
